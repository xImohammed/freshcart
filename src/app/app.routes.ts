...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path:'forget',loadComponent:()=> import('./core/auth/components/forgetpass/forgetpass.component').then(c =>c.ForgetpassComponent)
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path:'product-details/:id',loadComponent:()=>import('./feature/pages/product-details/product-details.component').then(c=>c.ProductDetailsComponent)
      },
      {
        path:'check-out',loadComponent:()=>import('./feature/pages/check-out/check-out.component').then((c)=>c.CheckOutComponent)
      },
      {
        path:'allorders',loadComponent:()=>import('./feature/pages/allorders/allorders.component').then((c)=>c.AllordersComponent)
      }
    ]
  },
  {
